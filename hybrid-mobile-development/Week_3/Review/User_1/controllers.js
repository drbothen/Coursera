...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $localStorage) {
  ...
  $scope.doReserve = function() {
    ...
    // Simulate a reservaton delay. Remove this and replace with your reserve
    // code if using a reservaton system
    $timeout(function() {
      $scope.closeReserve();
    }, 1000);
  };
...
function($scope, dishes, favoriteFactory, baseURL, $ionicListDelegate) {
  ...
  .controller('FeedbackController', ['$scope', 'feedbackFactory',
    function($scope, feedbackFactory) {
      ...
      $scope.feedback = feedbackFactory.getNewFeedback();
      ...
      $scope.sendFeedback = function() {
          ...
          if ($scope.feedback.agree && ($scope.feedback.mychannel === "")) {
              ...
              feedbackFactory.saveFeedback($scope.feedback);//saving feedback to sever
              $scope.invalidChannelSelection = false;
              $scope.feedback = feedbackFactory.getNewFeedback();
  ...
  '$ionicPopover', 'favoriteFactory', '$ionicModal',
    function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory,
    $ionicModal) {
      $scope.baseURL = baseURL;
      $scope.newComment = {
        rating: "5"
